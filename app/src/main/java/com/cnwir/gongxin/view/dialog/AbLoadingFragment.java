...
public class AbLoadingFragment extends DialogFragment{
	...
	public void load(View v){
		...
		AbAnimationUtil.playRotateAnimation(mIndeterminateView, 800, Animation.INFINITE,
				Animation.RESTART);
	}
