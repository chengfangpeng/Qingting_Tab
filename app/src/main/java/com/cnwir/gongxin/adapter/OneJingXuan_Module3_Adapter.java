 ...
 */
public class OneJingXuan_Module3_Adapter extends BaseAdapter {
	...
	public OneJingXuan_Module3_Adapter(One_JingXuanFragment fragment, GridView gridview, List<Jingxuan_model_item> data) {
	...
	public void updateData(List<Jingxuan_model_item> tem_datas, int index) {
		if (tem_datas != null) {
			if (index + 3 < tem_datas.size()) {
				this.datas = tem_datas.subList(index, index + 3);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.one_jingxuan_model_3_item, null);
		...
		holder.count.setText(info.share + "次推荐");
