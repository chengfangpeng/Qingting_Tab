 ...
 */
public class AbBottomTabView_fix extends LinearLayout {
	...
	public AbBottomTabView_fix(Context context, AttributeSet attrs) {
		...
		if(!(this.context instanceof FragmentActivity)){
			AbLogUtil.e(AbBottomTabView_fix.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
		...
		mFragmentPagerAdapter = new AbFragmentPagerStateAdapter(
